...
import me.zhengjie.enums.RequestMethodEnum;
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authenticationEntryPoint((request, response, e) -> {
                    ...
                    RestResponse restResponse = RestResponse.error(HttpServletResponse.SC_FORBIDDEN, "已过期，请重新登录");
                    log.error("auth failed：{}", "已过期，请重新登录");
                ...
                .accessDeniedHandler((request, response, e) -> {
                    ...
                    response.setContentType("application/json;charset=utf-8");
                    PrintWriter out = response.getWriter();
                    RestResponse data = RestResponse.error("权限不足，请联系管理员");
                    log.error("权限不足", e);
