...
//    User findByEmail(String email);
    ...
    @Modifying
    @Query(value = "update sys_user set last_login_time = ?2 where user_id = ?1", nativeQuery = true)
    void updateByLastLogin(Long id, Date date);

    @Modifying
    @Query(value = "update sys_user set pwd_reset_time = ?2 , phone =?3 where user_id = ?1", nativeQuery = true)
    void updatePhone(Long id, Date pwdResetTime, String phone);
}
